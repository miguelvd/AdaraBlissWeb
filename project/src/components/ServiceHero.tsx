...
export const ServiceHero = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white overflow-hidden">
      <h1 className="text-5xl md:text-6xl text-center pt-24 pb-12 text-[#F25AA3] font-semibold">
        Nuestros Servicios
      </h1>
      ...
      />
      <motion.div
        className="absolute right-[15%] bottom-[30%] w-16 h-16 rounded-full bg-[#F25AA3]/30"
        animate={{
      ...
      />
      <motion.div
        className="absolute left-[30%] top-[40%] w-20 h-20 rounded-full bg-[#F25AA3]/25"
        animate={{
          scale: selectedService === 'corte' ? 1.5 : selectedService ? 0.7 : 1,
          opacity: selectedService === 'corte' ? 0.7 : selectedService ? 0.2 : 0.25,
          x: selectedService === 'corte' ? 60 : 0,
          y: selectedService === 'corte' ? 40 : 0,
        }}
        transition={{ duration: 0.8, ease: "easeInOut" }}
      />
      <motion.div
        className="absolute right-[25%] top-[25%] w-12 h-12 rounded-full bg-[#F25AA3]/35"
        animate={{
      ...
      />
      <motion.div
        className="absolute left-[20%] bottom-[35%] w-14 h-14 rounded-full bg-[#F25AA3]/40"
        animate={{
      ...
      <motion.div
        ...
        animate={{
          width: selectedService ? (
            ...
            selectedService === 'cejas' ? '90vh' : '40vh'
          ) : '40vh',
          ...
          opacity: selectedService ? (
            selectedService === 'alisado' ? 0.6 :
            selectedService === 'botox' ? 0.3 :
            selectedService === 'corte' ? 0.5 :
            selectedService === 'maquillaje' ? 0.7 :
            selectedService === 'cejas' ? 0.4 : 0.4
          ) : 0.4,
          x: selectedService ? (
        ...
        <div className="relative w-full h-full max-w-[95%] sm:max-w-[90%] md:max-w-[70%] mx-auto">
          ...
          >
            <img
              ...
              alt="Main hero"
              className="w-full h-[75vh] sm:h-[70vh] md:h-[80vh] object-contain"
            />
          </motion.div>
      ...
      <div className="absolute bottom-8 left-0 right-0 px-2 sm:px-4 z-10">
        <motion.div 
        ...
        >
          ...
          <div className="absolute inset-0 bg-black rounded-[24px] -top-4 -bottom-4"></div>
                ...
                >
                  ...
                  >
                    <img 
                      ...
                      onError={(e) => {
                        console.error(`Error loading icon for ${service.id}:`, e);
