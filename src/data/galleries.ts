...
export const galleries: Record<string, GalleryCategory> = {
    ...
    images: [
      {
        ...
        alt: 'Corte de Cabello - Resultado 1',
      ...
      },
      {
        ...
        alt: 'Corte de Cabello - Resultado 2',
      ...
      },
      {
        ...
        alt: 'Corte de Cabello - Resultado 3',
  ...
  maquillaje: {
    id: 'maquillaje',
    title: 'Maquillaje',
    description: 'Arte y belleza en cada trazo',
    coverImage: '/images/gallery/Maquillaje/97a719a5-2d90-4f93-a720-fccc6d1a2b7d.jpg',
    images: [
      {
        url: '/images/gallery/Maquillaje/97a719a5-2d90-4f93-a720-fccc6d1a2b7d.jpg',
        alt: 'Maquillaje Profesional - Look Completo',
      ...
      },
      {
        ...
        alt: 'Maquillaje Profesional - Ojos Ahumados',
      ...
      },
      {
        ...
        alt: 'Maquillaje Profesional - Look Natural',
      ...
      },
      {
        ...
        alt: 'Maquillaje Profesional - Detalles de Ojos',
      ...
      },
      {
        ...
        alt: 'Maquillaje Profesional - Look Glamour',
      ...
      },
      {
        ...
        alt: 'Maquillaje Profesional - Look Elegante',
      ...
      },
      {
        ...
        alt: 'Maquillaje Profesional - Look Sofisticado',
      ...
      },
      {
        ...
        alt: 'Maquillaje Profesional - Look Radiante',
  ...
  cejas: {
    id: 'cejas',
    title: 'Cejas',
    description: 'Diseño y definición perfecta para tu mirada',
