...
const services = [
  { id: 'alisado', name: 'Alisado', icon: '/icons/alisado.png' },
  { id: 'botox', name: 'Botox', icon: '/icons/botox.png' },
  { id: 'corte', name: 'Corte', icon: '/icons/corte.png' },
  { id: 'maquillaje', name: 'Maquillaje', icon: '/icons/maquillaje.png' },
  { id: 'cejas', name: 'Cejas', icon: '/icons/cejas.png' }
];
